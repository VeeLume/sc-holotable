...
impl Pooled for DaylightParticleGroupComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_vfx.daylight_particle_group_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_vfx.daylight_particle_group_component_params
    }
}
...
impl<'a> Extract<'a> for DaylightParticleGroupComponentParams {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            activation_behavior: DaylightParticleGroupActivation::from_dcb_str(
                inst.get_str("activationBehavior").unwrap_or(""),
            ),
        }
    }
}
...
impl Pooled for PlacedSurfaceEffects_Emitter {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_vfx.placed_surface_effects_emitter
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_vfx.placed_surface_effects_emitter
    }
}
...
impl Pooled for SurfaceRaindropsTargetComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_vfx.surface_raindrops_target_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_vfx.surface_raindrops_target_component_params
    }
}
