...
impl Pooled for WaterShapeComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_watervolume.water_shape_component_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_watervolume.water_shape_component_params }
}
...
impl Pooled for EntityComponentWaterVolumeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_watervolume.entity_component_water_volume_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_watervolume.entity_component_water_volume_params }
}
