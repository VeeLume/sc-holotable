...
impl Pooled for SCItemVehicleDebrisParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_scitem_scitem_debris.scitem_vehicle_debris_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_scitem_scitem_debris.scitem_vehicle_debris_params }
}
