...
impl Pooled for ActivityBehaviorRequestCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.activity_behavior_request_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.activity_behavior_request_condition
    }
}
...
impl Pooled for IObservableExtender {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.iobservable_extender
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.iobservable_extender
    }
}
...
impl Pooled for IVisionComponentAdapter {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ivision_component_adapter
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ivision_component_adapter
    }
}
...
impl Pooled for MovementSystemAdditionalParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.movement_system_additional_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.movement_system_additional_params
    }
}
...
impl Pooled for NavLinkLocation {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.nav_link_location
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.nav_link_location
    }
}
...
impl Pooled for NavigationLinkController {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.navigation_link_controller
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.navigation_link_controller
    }
}
...
impl Pooled for TraversalCostShapeConfig {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.traversal_cost_shape_config
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.traversal_cost_shape_config
    }
}
...
impl Pooled for NavigationTriggerAdapter {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.navigation_trigger_adapter
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.navigation_trigger_adapter
    }
}
...
impl Pooled for INavigationCostVolumeExtender {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.inavigation_cost_volume_extender
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.inavigation_cost_volume_extender
    }
}
...
impl Pooled for ActionAreaExtensionType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.action_area_extension_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.action_area_extension_type
    }
}
...
impl Pooled for SActorForceReactionProceduralLeanPoseList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sactor_force_reaction_procedural_lean_pose_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sactor_force_reaction_procedural_lean_pose_list
    }
}
...
impl Pooled for IMannequinActionDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.imannequin_action_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.imannequin_action_def
    }
}
...
impl Pooled for SActorStanceDimensionsExtraDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sactor_stance_dimensions_extra_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sactor_stance_dimensions_extra_def
    }
}
...
impl Pooled for StatusEffectValue {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.status_effect_value
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.status_effect_value
    }
}
...
impl Pooled for StatusEffectSetupBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.status_effect_setup_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.status_effect_setup_base
    }
}
...
impl Pooled for StatusMaskedRetriggerSetupBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.status_masked_retrigger_setup_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.status_masked_retrigger_setup_base
    }
}
...
impl Pooled for LinkedStatPassValueBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.linked_stat_pass_value_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.linked_stat_pass_value_base
    }
}
...
impl Pooled for LinkedStatRuleBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.linked_stat_rule_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.linked_stat_rule_base
    }
}
...
impl Pooled for StatusBuffTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.status_buff_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.status_buff_type_base
    }
}
...
impl Pooled for BuffDurationBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.buff_duration_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.buff_duration_base
    }
}
...
impl Pooled for CounterMeasureBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.counter_measure_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.counter_measure_base_params
    }
}
...
impl Pooled for SSequencerAnimationTaskParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_animation_task_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_animation_task_params_base
    }
}
...
impl Pooled for AudioBreathStyleBaseNode {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.audio_breath_style_base_node
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.audio_breath_style_base_node
    }
}
...
impl Pooled for BuildingBlocks_Node {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_node
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_node
    }
}
...
impl Pooled for BuildingBlocks_BindingsPathBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_path_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_path_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsBooleanBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_boolean_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_boolean_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsIntegerBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_integer_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_integer_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsNumberBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_number_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_number_base
    }
}
...
impl Pooled for BindingsOperations_WaveformShapeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.bindings_operations_waveform_shape_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.bindings_operations_waveform_shape_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsStringBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_string_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_string_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsLocalizedBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_localized_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_localized_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsColorBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_color_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_color_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsVectorBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_vector_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_vector_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsRotationBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_rotation_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_rotation_base
    }
}
...
impl Pooled for BuildingBlocks_BindingsTransformBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_bindings_transform_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_bindings_transform_base
    }
}
...
impl Pooled for BuildingBlocks_LayoutPolicyBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_layout_policy_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_layout_policy_base
    }
}
...
impl Pooled for BuildingBlocks_LayoutPolicyItemBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_layout_policy_item_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_layout_policy_item_base
    }
}
...
impl Pooled for BuildingBlocks_ScrollPolicyBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_scroll_policy_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_scroll_policy_base
    }
}
...
impl Pooled for BuildingBlocks_FieldModifierBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_field_modifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_field_modifier_base
    }
}
...
impl Pooled for BuildingBlocks_FieldModifierEnumeratedTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools
            .core
            .building_blocks_field_modifier_enumerated_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools
            .core
...
impl Pooled for BuildingBlocks_RendererPolicyBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_renderer_policy_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_renderer_policy_base
    }
}
...
impl Pooled for BuildingBlocks_FieldModifierRecordRefTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools
            .core
            .building_blocks_field_modifier_record_ref_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools
            .core
...
impl Pooled for BuildingBlocks_TimingFunctionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_timing_function_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_timing_function_base
    }
}
...
impl Pooled for BuildingBlocks_TimelineTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_timeline_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_timeline_type_base
    }
}
...
impl Pooled for BuildingBlocks_TransformerBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_transformer_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_transformer_base
    }
}
...
impl Pooled for BuildingBlocks_SlicerBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_slicer_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_slicer_base
    }
}
...
impl Pooled for BuildingBlocks_TriggerBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_trigger_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_trigger_base
    }
}
...
impl Pooled for BuildingBlocks_TextFormatModifierBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_text_format_modifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_text_format_modifier_base
    }
}
...
impl Pooled for BuildingBlocks_StyleSelectorConditionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_style_selector_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_style_selector_condition_base
    }
}
...
impl Pooled for BuildingBlocks_ColorBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_color_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_color_base
    }
}
...
impl Pooled for BuildingBlocks_ContainerModeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.building_blocks_container_mode_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.building_blocks_container_mode_base
    }
}
...
impl Pooled for BaseCargoFillCapacityValue {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_cargo_fill_capacity_value
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_cargo_fill_capacity_value
    }
}
...
impl Pooled for SCustomzierColorDefBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scustomzier_color_def_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scustomzier_color_def_base
    }
}
...
impl Pooled for SCharacterCustomizerRandomizationParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scharacter_customizer_randomization_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scharacter_customizer_randomization_params
    }
}
...
impl Pooled for SCharacterValidationParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scharacter_validation_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scharacter_validation_params
    }
}
...
impl Pooled for LegacyCraftingCost_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.legacy_crafting_cost_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.legacy_crafting_cost_base
    }
}
...
impl Pooled for LegacyCraftingOutput_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.legacy_crafting_output_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.legacy_crafting_output_base
    }
}
...
impl Pooled for LegacyCraftingRecipe_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.legacy_crafting_recipe_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.legacy_crafting_recipe_base
    }
}
...
impl Pooled for LegacyCraftingRecipeDef_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.legacy_crafting_recipe_def_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.legacy_crafting_recipe_def_base
    }
}
...
impl Pooled for LegacyCraftingRecipeList_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.legacy_crafting_recipe_list_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.legacy_crafting_recipe_list_base
    }
}
...
impl Pooled for SSensorMineTriggerType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssensor_mine_trigger_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssensor_mine_trigger_type
    }
}
...
impl Pooled for HandholdAttachPointChoiceParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.handhold_attach_point_choice_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.handhold_attach_point_choice_params
    }
}
...
impl Pooled for HarvestableTagListBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.harvestable_tag_list_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.harvestable_tag_list_base
    }
}
...
impl Pooled for SubHarvestableConfigBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sub_harvestable_config_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sub_harvestable_config_base
    }
}
...
impl Pooled for SubHarvestableConfigSingleBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sub_harvestable_config_single_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sub_harvestable_config_single_base
    }
}
...
impl Pooled for HarvestConditionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.harvest_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.harvest_condition_base
    }
}
...
impl Pooled for HarvestableAreaTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.harvestable_area_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.harvestable_area_type_base
    }
}
...
impl Pooled for ItemThrottleParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_throttle_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_throttle_params_base
    }
}
...
impl Pooled for ItemModifierLifetime {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_modifier_lifetime
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_modifier_lifetime
    }
}
...
impl Pooled for BaseItemModifierParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_item_modifier_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_item_modifier_params
    }
}
...
impl Pooled for LightFlickerWaveParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.light_flicker_wave_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.light_flicker_wave_params
    }
}
...
impl Pooled for SMisfireCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.smisfire_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.smisfire_condition
    }
}
...
impl Pooled for SMisfireDamage {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.smisfire_damage
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.smisfire_damage
    }
}
...
impl Pooled for SLegacyItemMisfireParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.slegacy_item_misfire_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.slegacy_item_misfire_params
    }
}
...
impl Pooled for ParticleEffectNoneTintingParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.particle_effect_none_tinting_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.particle_effect_none_tinting_params
    }
}
...
impl Pooled for SQedVisualGraphTransitionTypeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sqed_visual_graph_transition_type_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sqed_visual_graph_transition_type_params
    }
}
...
impl Pooled for STargetingMethodBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.stargeting_method_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.stargeting_method_base
    }
}
...
impl Pooled for CtxGraph_Node {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ctx_graph_node
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ctx_graph_node
    }
}
...
impl Pooled for CtxGraph_Component {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ctx_graph_component
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ctx_graph_component
    }
}
...
impl Pooled for SCItemControllableParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_controllable_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_controllable_params
    }
}
...
impl Pooled for SCItemControlCondition_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_control_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_control_condition_base
    }
}
...
impl Pooled for SCItemControlBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_control_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_control_base_params
    }
}
...
impl Pooled for SCItemControlPriorityValue {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_control_priority_value
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_control_priority_value
    }
}
...
impl Pooled for ConversationNode_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.conversation_node_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.conversation_node_base
    }
}
...
impl Pooled for CraftingCostContext_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_cost_context_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_cost_context_base
    }
}
...
impl Pooled for CraftingOptionalEffect_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_optional_effect_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_optional_effect_base
    }
}
...
impl Pooled for CraftingGameplayPropertyModifierValueRange_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools
            .core
            .crafting_gameplay_property_modifier_value_range_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools
            .core
...
impl Pooled for CraftingGameplayPropertyModifier_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_gameplay_property_modifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_gameplay_property_modifier_base
    }
}
...
impl Pooled for CraftingGameplayPropertyModifiers_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_gameplay_property_modifiers_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_gameplay_property_modifiers_base
    }
}
...
impl Pooled for CraftingResult_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_result_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_result_base
    }
}
...
impl Pooled for CraftingRecipeCosts_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_recipe_costs_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_recipe_costs_base
    }
}
...
impl Pooled for CraftingRecipeCosts_Base_NonRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_recipe_costs_base_non_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_recipe_costs_base_non_ref
    }
}
...
impl Pooled for CraftingRecipeResults_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_recipe_results_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_recipe_results_base
    }
}
...
impl Pooled for CraftingProcessSpecificRecipeData_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_process_specific_recipe_data_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_process_specific_recipe_data_base
    }
}
...
impl Pooled for CraftingRecipe_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_recipe_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_recipe_base
    }
}
...
impl Pooled for CraftingRecipe_Base_NonRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_recipe_base_non_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_recipe_base_non_ref
    }
}
...
impl Pooled for CraftingResearchUnlock_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_research_unlock_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_research_unlock_base
    }
}
...
impl Pooled for CraftingResearch_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_research_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_research_base
    }
}
...
impl Pooled for CraftingBlueprintTier_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_blueprint_tier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_blueprint_tier_base
    }
}
...
impl Pooled for BlueprintCategoryAvailability_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.blueprint_category_availability_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.blueprint_category_availability_base
    }
}
...
impl Pooled for CraftingProcess_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_process_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_process_base
    }
}
...
impl Pooled for GenericCraftingProcess_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.generic_crafting_process_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.generic_crafting_process_base
    }
}
...
impl Pooled for CraftingBlueprint_Base_NonRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_blueprint_base_non_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_blueprint_base_non_ref
    }
}
...
impl Pooled for DefaultBlueprintSelection_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.default_blueprint_selection_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.default_blueprint_selection_base
    }
}
...
impl Pooled for CraftingQualityDistribution_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_quality_distribution_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_quality_distribution_base
    }
}
...
impl Pooled for CraftingQualityDistribution_Base_NonRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_quality_distribution_base_non_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_quality_distribution_base_non_ref
    }
}
...
impl Pooled for CraftingQualityLocationOverride_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_quality_location_override_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_quality_location_override_base
    }
}
...
impl Pooled for CraftingQualityLocationOverride_Base_NonRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.crafting_quality_location_override_base_non_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.crafting_quality_location_override_base_non_ref
    }
}
...
impl Pooled for CustomFloat {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.custom_float
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.custom_float
    }
}
...
impl Pooled for DamageBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.damage_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.damage_base
    }
}
...
impl Pooled for DamageResistanceBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.damage_resistance_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.damage_resistance_base
    }
}
...
impl Pooled for ExplosionBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.explosion_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.explosion_base_params
    }
}
...
impl Pooled for DefaultActionDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.default_action_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.default_action_def
    }
}
...
impl Pooled for DefaultActionsEntityEntryCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.default_actions_entity_entry_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.default_actions_entity_entry_condition
    }
}
...
impl Pooled for DefaultActionsEntityState {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.default_actions_entity_state
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.default_actions_entity_state
    }
}
...
impl Pooled for DialogueContextEntry {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.dialogue_context_entry
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.dialogue_context_entry
    }
}
...
impl Pooled for SIRoundsModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sirounds_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sirounds_module
    }
}
...
impl Pooled for SEffectParamsNodeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.seffect_params_node_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.seffect_params_node_base
    }
}
...
impl Pooled for DataForgeComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.data_forge_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.data_forge_component_params
    }
}
...
impl Pooled for EntityClassStaticDataParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.entity_class_static_data_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.entity_class_static_data_params
    }
}
...
impl Pooled for SHazardAreaShapeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.shazard_area_shape_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.shazard_area_shape_params
    }
}
...
impl Pooled for FloatUserVariableTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.float_user_variable_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.float_user_variable_task
    }
}
...
impl Pooled for IntUserVariableTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.int_user_variable_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.int_user_variable_task
    }
}
...
impl Pooled for BoolUserVariableTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.bool_user_variable_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.bool_user_variable_task
    }
}
...
impl Pooled for StringUserVariableTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.string_user_variable_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.string_user_variable_task
    }
}
...
impl Pooled for RecordRefUserVariableTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.record_ref_user_variable_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.record_ref_user_variable_type_base
    }
}
...
impl Pooled for CloneLocationMedicalTier {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.clone_location_medical_tier
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.clone_location_medical_tier
    }
}
...
impl Pooled for SSequencerCarryableTaskParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_carryable_task_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_carryable_task_params
    }
}
...
impl Pooled for ChatProviderSettingsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.chat_provider_settings_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.chat_provider_settings_base
    }
}
...
impl Pooled for SLoadoutRequirementBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sloadout_requirement_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sloadout_requirement_base
    }
}
...
impl Pooled for SSequencerEntityDragTaskParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_entity_drag_task_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_entity_drag_task_params
    }
}
...
impl Pooled for EATransportBaseTransitionParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.eatransport_base_transition_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.eatransport_base_transition_params
    }
}
...
impl Pooled for SItemMisfireParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sitem_misfire_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sitem_misfire_params
    }
}
...
impl Pooled for SObjectMetadataParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sobject_metadata_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sobject_metadata_params
    }
}
...
impl Pooled for SAnimatedOutfitSwapData {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sanimated_outfit_swap_data
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sanimated_outfit_swap_data
    }
}
...
impl Pooled for SSequencerDefTaskParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_def_task_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_def_task_params
    }
}
...
impl Pooled for SSpawnRules {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sspawn_rules
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sspawn_rules
    }
}
...
impl Pooled for BasePortRefillData {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_port_refill_data
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_port_refill_data
    }
}
...
impl Pooled for BaseSpawnerPrerequisite {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_spawner_prerequisite
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_spawner_prerequisite
    }
}
...
impl Pooled for SSequencerSpawnerTaskParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_spawner_task_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_spawner_task_params
    }
}
...
impl Pooled for SSequencerDespawnerTaskParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_despawner_task_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_despawner_task_params
    }
}
...
impl Pooled for SEntityEffectSystem_PropertyModifier {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sentity_effect_system_property_modifier
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sentity_effect_system_property_modifier
    }
}
...
impl Pooled for EntityEffectSystem_BaseSequencerTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.entity_effect_system_base_sequencer_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.entity_effect_system_base_sequencer_task
    }
}
...
impl Pooled for EventDispatcher {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.event_dispatcher
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.event_dispatcher
    }
}
...
impl Pooled for SEntityDensityClassOverridesBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sentity_density_class_overrides_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sentity_density_class_overrides_base
    }
}
...
impl Pooled for SEntityTraversingNodeTypeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sentity_traversing_node_type_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sentity_traversing_node_type_params
    }
}
...
impl Pooled for SEntityTraversingExecuteNodeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sentity_traversing_execute_node_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sentity_traversing_execute_node_base
    }
}
...
impl Pooled for FireVoxelSelectionShape {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.fire_voxel_selection_shape
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.fire_voxel_selection_shape
    }
}
...
impl Pooled for ExtinguishType_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.extinguish_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.extinguish_type_base
    }
}
...
impl Pooled for FireRepairerType_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.fire_repairer_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.fire_repairer_type_base
    }
}
...
impl Pooled for SRtpcBehaviour {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.srtpc_behaviour
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.srtpc_behaviour
    }
}
...
impl Pooled for SIPickupModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sipickup_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sipickup_module
    }
}
...
impl Pooled for SIDamageHandlingModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sidamage_handling_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sidamage_handling_module
    }
}
...
impl Pooled for SISpectatorModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sispectator_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sispectator_module
    }
}
...
impl Pooled for SIPlayerSetupModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.siplayer_setup_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.siplayer_setup_module
    }
}
...
impl Pooled for SIStatsRecordingModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sistats_recording_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sistats_recording_module
    }
}
...
impl Pooled for SINotificationsModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sinotifications_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sinotifications_module
    }
}
...
impl Pooled for SIObjectives {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.siobjectives
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.siobjectives
    }
}
...
impl Pooled for SICamerasModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sicameras_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sicameras_module
    }
}
...
impl Pooled for SIPlayerStats {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.siplayer_stats
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.siplayer_stats
    }
}
...
impl Pooled for SISpawning {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sispawning
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sispawning
    }
}
...
impl Pooled for SEASpawnRespawnSchedulerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.seaspawn_respawn_scheduler_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.seaspawn_respawn_scheduler_params
    }
}
...
impl Pooled for SIVictoryConditionsModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sivictory_conditions_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sivictory_conditions_module
    }
}
...
impl Pooled for SIParamsModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.siparams_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.siparams_module
    }
}
...
impl Pooled for SISubsumptionMissionModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sisubsumption_mission_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sisubsumption_mission_module
    }
}
...
impl Pooled for SChatChannelTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.schat_channel_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.schat_channel_type_base
    }
}
...
impl Pooled for ChatSystemOptionsModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.chat_system_options_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.chat_system_options_module
    }
}
...
impl Pooled for SIBettingModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sibetting_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sibetting_module
    }
}
...
impl Pooled for SIDifficultyModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sidifficulty_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sidifficulty_module
    }
}
...
impl Pooled for SIReputationModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sireputation_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sireputation_module
    }
}
...
impl Pooled for SIStateModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sistate_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sistate_module
    }
}
...
impl Pooled for SITeamsModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.siteams_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.siteams_module
    }
}
...
impl Pooled for SIVotingModule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sivoting_module
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sivoting_module
    }
}
...
impl Pooled for SGeometryModelTagBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sgeometry_model_tag_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sgeometry_model_tag_base
    }
}
...
impl Pooled for SInitialDamageSpecifierBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sinitial_damage_specifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sinitial_damage_specifier_base
    }
}
...
impl Pooled for EntityComponentHealth_SBaseSequencerTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.entity_component_health_sbase_sequencer_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.entity_component_health_sbase_sequencer_task
    }
}
...
impl Pooled for HitBehaviorBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.hit_behavior_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.hit_behavior_base
    }
}
...
impl Pooled for InnerThought_LayoutBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.inner_thought_layout_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.inner_thought_layout_base
    }
}
...
impl Pooled for SHighlightBehaviorNodeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.shighlight_behavior_node_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.shighlight_behavior_node_params
    }
}
...
impl Pooled for SInteractionPointPrimitiveParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sinteraction_point_primitive_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sinteraction_point_primitive_params
    }
}
...
impl Pooled for SStateModifier {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sstate_modifier
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sstate_modifier
    }
}
...
impl Pooled for SEntityContextBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sentity_context_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sentity_context_base
    }
}
...
impl Pooled for AttachableStateModifierContextBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.attachable_state_modifier_context_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.attachable_state_modifier_context_base
    }
}
...
impl Pooled for SBaseCargoUnit {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sbase_cargo_unit
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sbase_cargo_unit
    }
}
...
impl Pooled for InventoryContainerGridCellSizeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.inventory_container_grid_cell_size_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.inventory_container_grid_cell_size_base
    }
}
...
impl Pooled for InventoryContainerTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.inventory_container_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.inventory_container_type_base
    }
}
...
impl Pooled for BaseItem {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_item
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_item
    }
}
...
impl Pooled for BaseExpirationTypeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_expiration_type_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_expiration_type_params
    }
}
...
impl Pooled for SItemPortRuleDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sitem_port_rule_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sitem_port_rule_def
    }
}
...
impl Pooled for SItemPortDefExtensionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sitem_port_def_extension_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sitem_port_def_extension_base
    }
}
...
impl Pooled for SItemPortDefAttachmentImplementationBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sitem_port_def_attachment_implementation_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sitem_port_def_attachment_implementation_base
    }
}
...
impl Pooled for PlacementValidator {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.placement_validator
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.placement_validator
    }
}
...
impl Pooled for ItemResourceDynamicAmountBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_dynamic_amount_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_dynamic_amount_base
    }
}
...
impl Pooled for ItemResourceConversionModifierBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_conversion_modifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_conversion_modifier_base
    }
}
...
impl Pooled for ItemResourceDynamicCompositionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_dynamic_composition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_dynamic_composition_base
    }
}
...
impl Pooled for ItemResourceControlOutputBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_control_output_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_control_output_base
    }
}
...
impl Pooled for ItemResourceControlParameterBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_control_parameter_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_control_parameter_base
    }
}
...
impl Pooled for ItemResourceControlConditionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_control_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_control_condition_base
    }
}
...
impl Pooled for ItemResourceDynamicResourceBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_dynamic_resource_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_dynamic_resource_base
    }
}
...
impl Pooled for SBaseResourceUnit {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sbase_resource_unit
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sbase_resource_unit
    }
}
...
impl Pooled for ItemResourceDeltaBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_resource_delta_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_resource_delta_base
    }
}
...
impl Pooled for FunctionalityModifierBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.functionality_modifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.functionality_modifier_base
    }
}
...
impl Pooled for BaseJournalEntry {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_journal_entry
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_journal_entry
    }
}
...
impl Pooled for ILightAIExtender {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ilight_aiextender
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ilight_aiextender
    }
}
...
impl Pooled for ControlHintCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.control_hint_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.control_hint_condition
    }
}
...
impl Pooled for ControlHintAlwaysDisplayCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.control_hint_always_display_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.control_hint_always_display_condition
    }
}
...
impl Pooled for LongTermPersistenceSubTypeListOption {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.long_term_persistence_sub_type_list_option
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.long_term_persistence_sub_type_list_option
    }
}
...
impl Pooled for EntryOptionalData_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.entry_optional_data_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.entry_optional_data_base
    }
}
...
impl Pooled for EntityClassList_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.entity_class_list_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.entity_class_list_base
    }
}
...
impl Pooled for PoolFilter_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.pool_filter_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.pool_filter_base
    }
}
...
impl Pooled for PoolFilter_NoRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.pool_filter_no_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.pool_filter_no_ref
    }
}
...
impl Pooled for LootTableV3_NoRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_table_v3_no_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_table_v3_no_ref
    }
}
...
impl Pooled for LootArchetypeV3_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_archetype_v3_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_archetype_v3_base
    }
}
...
impl Pooled for LootArchetypeV3_NoRef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_archetype_v3_no_ref
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_archetype_v3_no_ref
    }
}
...
impl Pooled for LootArchetypeV3Selector_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_archetype_v3_selector_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_archetype_v3_selector_base
    }
}
...
impl Pooled for ArchetypeOptionalDataV3_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.archetype_optional_data_v3_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.archetype_optional_data_v3_base
    }
}
...
impl Pooled for SpawnWithV3Selector_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.spawn_with_v3_selector_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.spawn_with_v3_selector_base
    }
}
...
impl Pooled for LootTableOptionalDataV3_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_table_optional_data_v3_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_table_optional_data_v3_base
    }
}
...
impl Pooled for LootV3SecondaryChoicesRecordRef_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_v3_secondary_choices_record_ref_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_v3_secondary_choices_record_ref_base
    }
}
...
impl Pooled for LootV3SecondaryChoiceEntrySelector_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loot_v3_secondary_choice_entry_selector_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loot_v3_secondary_choice_entry_selector_base
    }
}
...
impl Pooled for QuantityRange_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.quantity_range_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.quantity_range_base
    }
}
...
impl Pooled for MapDisplayStartModeBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.map_display_start_mode_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.map_display_start_mode_base_params
    }
}
...
impl Pooled for Marker_ShowRule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.marker_show_rule
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.marker_show_rule
    }
}
...
impl Pooled for Marker_AbilityBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.marker_ability_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.marker_ability_base
    }
}
...
impl Pooled for VisibilityConditionDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.visibility_condition_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.visibility_condition_def
    }
}
...
impl Pooled for MissionLocationValidation {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.mission_location_validation
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.mission_location_validation
    }
}
...
impl Pooled for ContractGenerationParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.contract_generation_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.contract_generation_params_base
    }
}
...
impl Pooled for SContractPlugin_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scontract_plugin_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scontract_plugin_base
    }
}
...
impl Pooled for ContractPrerequisiteBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.contract_prerequisite_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.contract_prerequisite_base
    }
}
...
impl Pooled for ItemAwardWeightingsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_award_weightings_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_award_weightings_base
    }
}
...
impl Pooled for ContractClassBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.contract_class_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.contract_class_base
    }
}
...
impl Pooled for HaulingOrderContentBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.hauling_order_content_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.hauling_order_content_base
    }
}
...
impl Pooled for Hauling_EntityClassListBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.hauling_entity_class_list_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.hauling_entity_class_list_base
    }
}
...
impl Pooled for HaulingOrder_OrOption_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.hauling_order_or_option_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.hauling_order_or_option_base
    }
}
...
impl Pooled for MissionFlowConditionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.mission_flow_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.mission_flow_condition_base
    }
}
...
impl Pooled for MissionFlowActionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.mission_flow_action_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.mission_flow_action_base
    }
}
...
impl Pooled for BaseMissionPropertyValue {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_mission_property_value
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_mission_property_value
    }
}
...
impl Pooled for BaseDataSetMatchCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_data_set_match_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_data_set_match_condition
    }
}
...
impl Pooled for LocationEntityType_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.location_entity_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.location_entity_type_base
    }
}
...
impl Pooled for ModuleDeclarationType_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.module_declaration_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.module_declaration_type_base
    }
}
...
impl Pooled for ObjectivePropertyBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.objective_property_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.objective_property_base
    }
}
...
impl Pooled for ObjectiveHandlerBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.objective_handler_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.objective_handler_base
    }
}
...
impl Pooled for ObjectiveRewardContributionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.objective_reward_contribution_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.objective_reward_contribution_base
    }
}
...
impl Pooled for MusicLogicNode {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.music_logic_node
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.music_logic_node
    }
}
...
impl Pooled for SObjectDataBankEntryTrackerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sobject_data_bank_entry_tracker_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sobject_data_bank_entry_tracker_params
    }
}
...
impl Pooled for SandboxInfractionBaseDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sandbox_infraction_base_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sandbox_infraction_base_def
    }
}
...
impl Pooled for SandboxTriggerBaseDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sandbox_trigger_base_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sandbox_trigger_base_def
    }
}
...
impl Pooled for MissionCompletePerkBaseDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.mission_complete_perk_base_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.mission_complete_perk_base_def
    }
}
...
impl Pooled for CoolingEqualizationParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.cooling_equalization_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.cooling_equalization_params_base
    }
}
...
impl Pooled for PlayerAnimatedInteractionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.player_animated_interaction_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.player_animated_interaction_base
    }
}
...
impl Pooled for PlayerChoiceMenuOption {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.player_choice_menu_option
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.player_choice_menu_option
    }
}
...
impl Pooled for PlanetDayNightTemperatureBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.planet_day_night_temperature_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.planet_day_night_temperature_base_params
    }
}
...
impl Pooled for ProceduralLayoutNode_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.procedural_layout_node_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.procedural_layout_node_base
    }
}
...
impl Pooled for SQuantumDriveEffectBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.squantum_drive_effect_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.squantum_drive_effect_base_params
    }
}
...
impl Pooled for SCItemRadarSensitivityModifierType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_radar_sensitivity_modifier_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_radar_sensitivity_modifier_type
    }
}
...
impl Pooled for ScanCustomValue {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scan_custom_value
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scan_custom_value
    }
}
...
impl Pooled for ScanDisplayConditionBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scan_display_condition_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scan_display_condition_base_params
    }
}
...
impl Pooled for SBBDynamicPropertyBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sbbdynamic_property_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sbbdynamic_property_base
    }
}
...
impl Pooled for SReputationStateModifierBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sreputation_state_modifier_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sreputation_state_modifier_base
    }
}
...
impl Pooled for SReputationMissionRequirementExpressionElement {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools
            .core
            .sreputation_mission_requirement_expression_element
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools
            .core
...
impl Pooled for BaseDensityUnit {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_density_unit
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_density_unit
    }
}
...
impl Pooled for ResourceTypeDensityType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.resource_type_density_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.resource_type_density_type
    }
}
...
impl Pooled for RoomExtension {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.room_extension
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.room_extension
    }
}
...
impl Pooled for VolumeShape {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.volume_shape
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.volume_shape
    }
}
...
impl Pooled for SAtmosphericCompositionBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.satmospheric_composition_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.satmospheric_composition_base_params
    }
}
...
impl Pooled for AsteroidStateBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.asteroid_state_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.asteroid_state_base
    }
}
...
impl Pooled for AtmosphereStateBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.atmosphere_state_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.atmosphere_state_base
    }
}
...
impl Pooled for AerodynamicTrailCalculation {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.aerodynamic_trail_calculation
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.aerodynamic_trail_calculation
    }
}
...
impl Pooled for ElectricalStateBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.electrical_state_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.electrical_state_base
    }
}
...
impl Pooled for RadiationStateBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.radiation_state_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.radiation_state_base
    }
}
...
impl Pooled for SBaseInteractionGameplayTrigger {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sbase_interaction_gameplay_trigger
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sbase_interaction_gameplay_trigger
    }
}
...
impl Pooled for SDisruptionGameplayTriggerType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sdisruption_gameplay_trigger_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sdisruption_gameplay_trigger_type
    }
}
...
impl Pooled for DegradationAction {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.degradation_action
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.degradation_action
    }
}
...
impl Pooled for LoadoutCheckType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loadout_check_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loadout_check_type
    }
}
...
impl Pooled for SCheckType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scheck_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scheck_type
    }
}
...
impl Pooled for GameplayTrigger_FilterType_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.gameplay_trigger_filter_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.gameplay_trigger_filter_type_base
    }
}
...
impl Pooled for GameplayTrigger_Executor_ActivateInteraction_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools
            .core
            .gameplay_trigger_executor_activate_interaction_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools
            .core
...
impl Pooled for GameplayTrigger_Executor_SetInteractionState_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools
            .core
            .gameplay_trigger_executor_set_interaction_state_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools
            .core
...
impl Pooled for GT_CommunicationMessage {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.gt_communication_message
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.gt_communication_message
    }
}
...
impl Pooled for GT_CommunicationTarget {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.gt_communication_target
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.gt_communication_target
    }
}
...
impl Pooled for EntityFilter {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.entity_filter
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.entity_filter
    }
}
...
impl Pooled for AreaCommunicationMessage {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.area_communication_message
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.area_communication_message
    }
}
...
impl Pooled for SelfCommunicationMessage {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.self_communication_message
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.self_communication_message
    }
}
...
impl Pooled for GameplayTriggerCondition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.gameplay_trigger_condition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.gameplay_trigger_condition
    }
}
...
impl Pooled for ConditionalResult {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.conditional_result
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.conditional_result
    }
}
...
impl Pooled for TriggeredHealth {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.triggered_health
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.triggered_health
    }
}
...
impl Pooled for SModHealth {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.smod_health
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.smod_health
    }
}
...
impl Pooled for VulnerabilityState {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.vulnerability_state
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.vulnerability_state
    }
}
...
impl Pooled for GameplayTrigger_Physics_SetParameter_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.gameplay_trigger_physics_set_parameter_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.gameplay_trigger_physics_set_parameter_base
    }
}
...
impl Pooled for SUserVariableOperationType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.suser_variable_operation_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.suser_variable_operation_type
    }
}
...
impl Pooled for GameplayTrigger_InterpolationType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.gameplay_trigger_interpolation_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.gameplay_trigger_interpolation_type
    }
}
...
impl Pooled for ClothingType {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.clothing_type
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.clothing_type
    }
}
...
impl Pooled for PurchasableDisplayBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.purchasable_display_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.purchasable_display_base
    }
}
...
impl Pooled for SCItemProximitySensorShapeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_proximity_sensor_shape_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_proximity_sensor_shape_params
    }
}
...
impl Pooled for SDoorCollisionReactionBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sdoor_collision_reaction_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sdoor_collision_reaction_base_params
    }
}
...
impl Pooled for SCItemDoorPortalModeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_door_portal_mode_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_door_portal_mode_params
    }
}
...
impl Pooled for SSequencerItemDoorTaskParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_item_door_task_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_item_door_task_params
    }
}
...
impl Pooled for AccessibilityBaseParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.accessibility_base_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.accessibility_base_params
    }
}
...
impl Pooled for SElevatorBaseCollisionParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.selevator_base_collision_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.selevator_base_collision_params
    }
}
...
impl Pooled for BaseHoloDisplayProvider {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.base_holo_display_provider
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.base_holo_display_provider
    }
}
...
impl Pooled for WorldDisplayEnvironmentColor {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.world_display_environment_color
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.world_display_environment_color
    }
}
...
impl Pooled for SToolArmDeployCondition_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.stool_arm_deploy_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.stool_arm_deploy_condition_base
    }
}
...
impl Pooled for SCItemTurretAngleLimitParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.scitem_turret_angle_limit_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.scitem_turret_angle_limit_params
    }
}
...
impl Pooled for WeaponAIAimingMethod {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.weapon_aiaiming_method
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.weapon_aiaiming_method
    }
}
...
impl Pooled for SLauncherBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.slauncher_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.slauncher_base
    }
}
...
impl Pooled for SWeaponConditionBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sweapon_condition_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sweapon_condition_base
    }
}
...
impl Pooled for SAuxiliaryWeaponActionParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sauxiliary_weapon_action_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sauxiliary_weapon_action_params
    }
}
...
impl Pooled for ItemRecoverySetConditionDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_recovery_set_condition_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_recovery_set_condition_def
    }
}
...
impl Pooled for SSCSignatureEmissionBaseModifier {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sscsignature_emission_base_modifier
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sscsignature_emission_base_modifier
    }
}
...
impl Pooled for SSCSignatureParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sscsignature_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sscsignature_params_base
    }
}
...
impl Pooled for SSCSignatureSystemCrossSectionParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sscsignature_system_cross_section_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sscsignature_system_cross_section_params
    }
}
...
impl Pooled for SSCSignatureSystemAudioModifier {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sscsignature_system_audio_modifier
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sscsignature_system_audio_modifier
    }
}
...
impl Pooled for SSCSignatureSystemAudioSubRule {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sscsignature_system_audio_sub_rule
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sscsignature_system_audio_sub_rule
    }
}
...
impl Pooled for CompletionTypeBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.completion_type_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.completion_type_base
    }
}
...
impl Pooled for ScreenEffects_ParamValue {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.screen_effects_param_value
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.screen_effects_param_value
    }
}
...
impl Pooled for SecurityClearance_OutfitRequirementDef {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.security_clearance_outfit_requirement_def
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.security_clearance_outfit_requirement_def
    }
}
...
impl Pooled for SecurityManualInput {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.security_manual_input
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.security_manual_input
    }
}
...
impl Pooled for SecurityNotifications {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.security_notifications
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.security_notifications
    }
}
...
impl Pooled for SecurityNetworkVariableValue_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.security_network_variable_value_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.security_network_variable_value_base
    }
}
...
impl Pooled for SecurityNetworkVariableEffect_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.security_network_variable_effect_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.security_network_variable_effect_base
    }
}
...
impl Pooled for SServiceBeaconCreatorParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sservice_beacon_creator_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sservice_beacon_creator_params_base
    }
}
...
impl Pooled for TimeValue_Base {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.time_value_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.time_value_base
    }
}
...
impl Pooled for TransportPermissionsInterface {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.transport_permissions_interface
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.transport_permissions_interface
    }
}
...
impl Pooled for ItemPortViewInformation {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.item_port_view_information
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.item_port_view_information
    }
}
...
impl Pooled for LoadoutEditorAdditionalParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.loadout_editor_additional_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.loadout_editor_additional_params
    }
}
...
impl Pooled for AreaAlignmentSlotTypeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.area_alignment_slot_type_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.area_alignment_slot_type_params
    }
}
...
impl Pooled for SSpecializedDataEntry {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.sspecialized_data_entry
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.sspecialized_data_entry
    }
}
...
impl Pooled for UsableSlottingReferenceElementBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.usable_slotting_reference_element_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.usable_slotting_reference_element_base
    }
}
...
impl Pooled for SSequencerUsableTask {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.ssequencer_usable_task
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.ssequencer_usable_task
    }
}
...
impl Pooled for WeatherEffects_Asteroid {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.weather_effects_asteroid
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.weather_effects_asteroid
    }
}
...
impl Pooled for WeatherEffects_Atmosphere {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.weather_effects_atmosphere
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.weather_effects_atmosphere
    }
}
...
impl Pooled for MobiGlasAppDataBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.mobi_glas_app_data_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.mobi_glas_app_data_base
    }
}
...
impl Pooled for SMobiGlasAppDataPacketBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.smobi_glas_app_data_packet_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.smobi_glas_app_data_packet_base
    }
}
...
impl Pooled for SMobiGlasAppParamsBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.core.smobi_glas_app_params_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.core.smobi_glas_app_params_base
    }
}
