...
impl Pooled for AINavigationObstacleParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_ainavigationobstacle.ainavigation_obstacle_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_ainavigationobstacle.ainavigation_obstacle_params }
}
