...
//! Types for feature `entities-colorgradient`.
...
impl Pooled for ColorGradientComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_colorgradient.color_gradient_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_colorgradient.color_gradient_component_params
    }
}
