...
impl Pooled for SpecialEventManufacturer {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.specialeventdatabase.special_event_manufacturer
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.specialeventdatabase.special_event_manufacturer
    }
}
...
impl Pooled for SpecialEventDay {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.specialeventdatabase.special_event_day
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.specialeventdatabase.special_event_day
    }
}
...
impl Pooled for SpecialEventDatabase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.specialeventdatabase.special_event_database
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.specialeventdatabase.special_event_database
    }
}
