...
impl Pooled for SHealingBeamBoneEntryParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.sglobalhealingbeamparams.shealing_beam_bone_entry_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.sglobalhealingbeamparams.shealing_beam_bone_entry_params }
}
...
impl Pooled for SHealingBeamBodyPartHighlightingParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.sglobalhealingbeamparams.shealing_beam_body_part_highlighting_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.sglobalhealingbeamparams.shealing_beam_body_part_highlighting_params }
}
...
impl Pooled for SHealingBeamBodyPartParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.sglobalhealingbeamparams.shealing_beam_body_part_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.sglobalhealingbeamparams.shealing_beam_body_part_params }
}
...
impl Pooled for SGlobalHealingBeamParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.sglobalhealingbeamparams.sglobal_healing_beam_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.sglobalhealingbeamparams.sglobal_healing_beam_params }
}
