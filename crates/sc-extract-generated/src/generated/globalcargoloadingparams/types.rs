...
impl Pooled for SAutoLoadingBoxSizeLoadingTime {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.globalcargoloadingparams.sauto_loading_box_size_loading_time }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.globalcargoloadingparams.sauto_loading_box_size_loading_time }
}
...
impl Pooled for GlobalCargoLoadingParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.globalcargoloadingparams.global_cargo_loading_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.globalcargoloadingparams.global_cargo_loading_params }
}
...
impl Pooled for CargoLoadingNotificationParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.globalcargoloadingparams.cargo_loading_notification_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.globalcargoloadingparams.cargo_loading_notification_params }
}
