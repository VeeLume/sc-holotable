...
impl Pooled for DigitalSignageContent {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_digitalsignage.digital_signage_content
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_digitalsignage.digital_signage_content
    }
}
...
impl Pooled for DigitalSignageContentSet {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_digitalsignage.digital_signage_content_set
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_digitalsignage.digital_signage_content_set
    }
}
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<DigitalSignageContent>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<DigitalSignageContent>(
