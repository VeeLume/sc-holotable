...
pub struct ProcedurallayoutPools {
    ...
    pub procedural_layout_node_element_properties:
        Vec<Option<ProceduralLayoutNode_ElementProperties>>,
    pub procedural_layout_graph_node_element: Vec<Option<ProceduralLayoutGraphNode_Element>>,
    pub procedural_layout_graph_node_multi_element:
        Vec<Option<ProceduralLayoutGraphNode_MultiElement>>,
    pub procedural_layout_supplementary_element_tags_options:
        Vec<Option<ProceduralLayout_SupplementaryElementTagsOptions>>,
