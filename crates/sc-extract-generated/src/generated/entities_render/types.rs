...
impl Pooled for SGeomCacheEntityComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_render.sgeom_cache_entity_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_render.sgeom_cache_entity_component_params
    }
}
...
impl<'a> Extract<'a> for SGeomCacheEntityComponentParams {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            geom_cache_file: inst
                .get_str("GeomCacheFile")
                .map(String::from)
                .unwrap_or_default(),
            ...
            stand_in_object: inst
                .get_str("StandInObject")
                .map(String::from)
                .unwrap_or_default(),
            stand_in_material: inst
                .get_str("StandInMaterial")
                .map(String::from)
                .unwrap_or_default(),
            first_frame_stand_in_object: inst
                .get_str("FirstFrameStandInObject")
                .map(String::from)
                .unwrap_or_default(),
            first_frame_stand_in_material: inst
                .get_str("FirstFrameStandInMaterial")
                .map(String::from)
                .unwrap_or_default(),
            last_frame_stand_in_object: inst
                .get_str("LastFrameStandInObject")
                .map(String::from)
                .unwrap_or_default(),
            last_frame_stand_in_material: inst
                .get_str("LastFrameStandInMaterial")
                .map(String::from)
                .unwrap_or_default(),
        }
    }
