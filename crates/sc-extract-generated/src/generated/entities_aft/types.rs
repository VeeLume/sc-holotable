...
impl Pooled for EntityEventCallbackComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_aft.entity_event_callback_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_aft.entity_event_callback_component_params
    }
}
...
impl Pooled for AreaEventCallbackComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_aft.area_event_callback_component_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_aft.area_event_callback_component_params
    }
}
