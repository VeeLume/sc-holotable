...
pub struct ContractsPools {
    ...
    pub scontract_plugin_smission_provider: Vec<Option<SContractPlugin_SMissionProvider>>,
    ...
    pub objective_handler_meet_and_talk: Vec<Option<ObjectiveHandler_MeetAndTalk>>,
