...
impl Pooled for AudioBreathStyleConditionList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_breath_style_condition_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_breath_style_condition_list
    }
}
...
impl Pooled for EntityAudioControllerTypeParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.entity_audio_controller_type_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.entity_audio_controller_type_params
    }
}
        ...
        Self {
            audio_controller_params: match inst.get("audioControllerParams") {
                Some(Value::StrongPointer(Some(r))) | Some(Value::WeakPointer(Some(r))) => {
                    Some(b.alloc_nested::<SEntityAudioControllerParams>(
...
impl Pooled for EntityAudioControllerTypeManagementParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.entity_audio_controller_type_management_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.entity_audio_controller_type_management_params
    }
}
...
impl<'a> Extract<'a> for EntityAudioControllerTypeManagementParams {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            audio_controller_entity_type: EAudioControllerEntityType::from_dcb_str(
                inst.get_str("audioControllerEntityType").unwrap_or(""),
            ),
...
impl Pooled for EntityAudioControllerManagerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.entity_audio_controller_manager_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.entity_audio_controller_manager_params
    }
}
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<EntityAudioControllerTypeManagementParams>(
...
impl Pooled for AudioWhitelist {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_whitelist
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_whitelist
    }
}
...
impl<'a> Extract<'a> for AudioWhitelist {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            trigger_types: inst
                .get_array("triggerTypes")
                .map(|arr| {
                    arr.filter_map(|v| v.as_str().map(EAudioTriggerType::from_dcb_str))
                        .collect()
                })
                .unwrap_or_default(),
        }
...
impl Pooled for AudioEnvironment {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_environment
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_environment
    }
}
...
impl<'a> Extract<'a> for AudioEnvironment {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            wwise_environment_name: inst
                .get_str("wwiseEnvironmentName")
                .map(String::from)
                .unwrap_or_default(),
            ...
            primary_surface_type: inst
                .get_str("primarySurfaceType")
                .map(String::from)
                .unwrap_or_default(),
            secondary_surface_type: inst
                .get_str("secondarySurfaceType")
                .map(String::from)
                .unwrap_or_default(),
        }
    }
...
impl Pooled for AudioOneShotManagerBudgetEntry {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_one_shot_manager_budget_entry
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_one_shot_manager_budget_entry
    }
}
...
impl<'a> Extract<'a> for AudioOneShotManagerBudgetEntry {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            ...
            priority_falloff_per_second: inst
                .get_f32("priorityFalloffPerSecond")
                .unwrap_or_default(),
        }
    }
}
...
impl Pooled for AudioBudgetDefinition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_budget_definition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_budget_definition
    }
}
...
impl<'a> Extract<'a> for AudioBudgetDefinition {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            oneshot_budget: inst
                .get_array("oneshotBudget")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<AudioOneShotManagerBudgetEntry>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
...
impl Pooled for AudioGameContextGlobals {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_game_context_globals
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_game_context_globals
    }
}
...
impl<'a> Extract<'a> for AudioGameContextGlobals {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            global_states: inst
                .get_array("globalStates")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => Some(b.alloc_nested::<AudioSwitch>(
                            Instance::from_inline_data(b.db, struct_index, data),
                            false,
                        )),
                        Value::ClassRef(r) => Some(b.alloc_nested::<AudioSwitch>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
                ...
                .unwrap_or_default(),
            global_rtpcs: inst
                .get_array("globalRTPCs")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<AudioRtpcWithDefault>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<AudioRtpcWithDefault>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for AudioGameContext {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_game_context
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_game_context
    }
}
...
impl<'a> Extract<'a> for AudioGameContext {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            budget_definition: inst
                .get("budgetDefinition")
                .and_then(|v| v.as_record_ref())
                .map(|r| r.guid),
            global_rtpcs_and_states: inst
                .get("globalRtpcsAndStates")
                .and_then(|v| v.as_record_ref())
                .map(|r| r.guid),
        }
    }
...
impl Pooled for AudioGameContextSetup {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_game_context_setup
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_game_context_setup
    }
}
...
impl Pooled for SurfaceAudioPropertiesDefinition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.surface_audio_properties_definition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.surface_audio_properties_definition
    }
}
...
impl<'a> Extract<'a> for SurfaceAudioPropertiesDefinition {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            surface_audio_props: inst
                .get_array("surfaceAudioProps")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<SurfaceAudioProperties>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<SurfaceAudioProperties>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for SurfaceAudioProperties {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.surface_audio_properties
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.surface_audio_properties
    }
}
...
impl<'a> Extract<'a> for SurfaceAudioProperties {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            collision_trigger_min_play_time: inst
                .get_f32("collisionTriggerMinPlayTime")
                .unwrap_or_default(),
...
impl Pooled for GlobalAudioSettings {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.global_audio_settings
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.global_audio_settings
    }
}
...
impl<'a> Extract<'a> for GlobalAudioSettings {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            enable_propagation_pathing: inst
                .get_bool("enablePropagationPathing")
                .unwrap_or_default(),
            enable_propagation_pathing_actor_only: inst
                .get_bool("enablePropagationPathingActorOnly")
                .unwrap_or_default(),
...
impl Pooled for AudioTagAction {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_tag_action
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_tag_action
    }
}
...
impl Pooled for AudioTagActionList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_tag_action_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_tag_action_list
    }
}
...
impl<'a> Extract<'a> for AudioTagActionList {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            tag_action_list: inst
                .get_array("tagActionList")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<AudioTagAction>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<AudioTagAction>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for AudioValueOutputBehaviour {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_value_output_behaviour
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_value_output_behaviour
    }
}
...
impl Pooled for AudioValueOutputBehaviourCamera {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_value_output_behaviour_camera
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_value_output_behaviour_camera
    }
}
...
impl<'a> Extract<'a> for AudioValueOutputBehaviourCamera {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            offset_angle_input: EAudioValueOutputCameraInputs::from_dcb_str(
                inst.get_str("offsetAngleInput").unwrap_or(""),
            ),
            ...
            offset_position_input: EAudioValueOutputCameraInputs::from_dcb_str(
                inst.get_str("offsetPositionInput").unwrap_or(""),
            ),
            ...
            offset_position_modifier_use: inst
                .get_bool("offsetPositionModifierUse")
                .unwrap_or_default(),
...
impl Pooled for AudioValueOutputBehaviourMicrophone {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_value_output_behaviour_microphone
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_value_output_behaviour_microphone
    }
}
...
impl Pooled for AudioValueOutput {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_value_output
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_value_output
    }
}
...
impl<'a> Extract<'a> for AudioValueOutput {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            behaviours: inst
                .get_array("behaviours")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::StrongPointer(Some(r)) | Value::WeakPointer(Some(r)) => {
                            Some(AudioValueOutputBehaviourPtr::from_ref(b, r))
                        }
                        _ => None,
                    })
                    .collect()
...
impl Pooled for AudioValueOutputSetup {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_value_output_setup
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_value_output_setup
    }
}
        ...
        Self {
            outputs: inst
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<AudioValueOutput>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<AudioValueOutput>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for QueueingBehaviour {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.queueing_behaviour
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.queueing_behaviour
    }
}
...
impl Pooled for CockpitResponseVariation {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.cockpit_response_variation
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.cockpit_response_variation
    }
}
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            queuing_behaviour: match inst.get("queuingBehaviour") {
                Some(Value::Class { struct_index, data }) => {
                    Some(b.alloc_nested::<QueueingBehaviour>(
                        Instance::from_inline_data(b.db, struct_index, data),
                        false,
                    ))
                }
            ...
            rules: inst
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::StrongPointer(Some(r)) | Value::WeakPointer(Some(r)) => {
                            Some(CockpitRuleBasePtr::from_ref(b, r))
                        }
                        _ => None,
                    })
                    .collect()
...
impl Pooled for CockpitResponse {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.cockpit_response
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.cockpit_response
    }
}
...
impl<'a> Extract<'a> for CockpitResponse {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            variations: inst
                .get_array("variations")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<CockpitResponseVariation>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<CockpitResponseVariation>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for CockpitResponses {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.cockpit_responses
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.cockpit_responses
    }
}
...
impl Pooled for CockpitRuleBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.cockpit_rule_base
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.cockpit_rule_base
    }
}
...
impl Pooled for CockpitRuleFloat {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.cockpit_rule_float
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.cockpit_rule_float
    }
}
...
impl Pooled for CockpitRuleString {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.cockpit_rule_string
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.cockpit_rule_string
    }
}
...
impl Pooled for AudioAllegianceSwitches {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_allegiance_switches
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_allegiance_switches
    }
}
...
impl Pooled for AudioSignalList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_signal_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_signal_list
    }
}
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            signals: inst
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => Some(b.alloc_nested::<AudioSignal>(
                            Instance::from_inline_data(b.db, struct_index, data),
                            false,
                        )),
                        Value::ClassRef(r) => Some(b.alloc_nested::<AudioSignal>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for TagToAudioRtpcList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.tag_to_audio_rtpc_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.tag_to_audio_rtpc_list
    }
}
...
impl<'a> Extract<'a> for TagToAudioRtpcList {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            tags_to_rtpcs: inst
                .get_array("TagsToRtpcs")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<TagToAudioRtpc>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<TagToAudioRtpc>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for AudioSignalRtpc {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_signal_rtpc
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_signal_rtpc
    }
}
...
impl Pooled for AudioSignal {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.audio_signal
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.audio_signal
    }
}
        ...
        Self {
            ...
            audio_triggers: inst
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        ...
                        Value::ClassRef(r) => Some(b.alloc_nested::<GlobalResourceAudio>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
            ...
            rtpcs: inst
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<AudioSignalRtpc>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<AudioSignalRtpc>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for TagToAudioRtpc {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.tag_to_audio_rtpc
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.tag_to_audio_rtpc
    }
}
...
impl Pooled for GPUParticleAudioList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.gpuparticle_audio_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.gpuparticle_audio_list
    }
}
...
impl<'a> Extract<'a> for GPUParticleAudioList {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            particle_audio_list: inst
                .get_array("particleAudioList")
                .map(|arr| {
                    arr.filter_map(|v| {
                        if let Value::Reference(Some(r)) = v {
                            Some(r.guid)
...
impl Pooled for CommsAudioEffect {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.comms_audio_effect
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.comms_audio_effect
    }
}
...
impl Pooled for ShipComputerPresetList {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.ship_computer_preset_list
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.ship_computer_preset_list
    }
}
...
impl Pooled for ShipComputerPreset {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.ship_computer_preset
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.ship_computer_preset
    }
}
...
impl Pooled for VideoCommsAudioParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.audio.video_comms_audio_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.audio.video_comms_audio_params
    }
}
