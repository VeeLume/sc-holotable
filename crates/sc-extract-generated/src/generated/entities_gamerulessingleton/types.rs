...
impl Pooled for SGameRulesComponentParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_gamerulessingleton.sgame_rules_component_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_gamerulessingleton.sgame_rules_component_params }
}
