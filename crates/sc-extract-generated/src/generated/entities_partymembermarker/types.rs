...
impl Pooled for SPartyMemberMarkerObjectMetadataParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_partymembermarker.sparty_member_marker_object_metadata_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_partymembermarker.sparty_member_marker_object_metadata_params }
}
...
impl Pooled for SEntityComponentPartyMarkerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_partymembermarker.sentity_component_party_marker_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_partymembermarker.sentity_component_party_marker_params }
}
...
impl Pooled for SPartyMemberEntryTrackerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_partymembermarker.sparty_member_entry_tracker_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_partymembermarker.sparty_member_entry_tracker_params }
}
