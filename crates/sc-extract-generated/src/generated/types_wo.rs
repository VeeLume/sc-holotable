...
pub struct WorldDisplayRadar {
    ...
    /// DCB field: `horizontalLine` (Class)
    #[serde(default)]
    pub horizontal_line: Option<Handle<WorldDisplayRadar_Line>>,
    /// DCB field: `verticalLine` (Class)
    #[serde(default)]
    pub vertical_line: Option<Handle<WorldDisplayRadar_Line>>,
}

impl Pooled for WorldDisplayRadar {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.b_wo.world_display_radar }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.b_wo.world_display_radar }
}
...
pub struct WorldDisplayRadar_Icon {
    ...
    #[serde(default)]
    pub enabled: bool,
    /// DCB field: `size` (Single)
    #[serde(default)]
    pub size: f32,
    /// DCB field: `spriteSlot` (Class)
    #[serde(default)]
    pub sprite_slot: Option<Handle<SimpleSpriteSlot>>,
}

impl Pooled for WorldDisplayRadar_Icon {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.b_wo.world_display_radar_icon }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.b_wo.world_display_radar_icon }
}
...
impl Pooled for WorldDisplayRadar_Line {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.b_wo.world_display_radar_line }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.b_wo.world_display_radar_line }
}
...
pub struct WorldDisplayEnvironment {
    /// DCB field: `environments` (StrongPointer (array))
    #[serde(default)]
    pub environments: Vec<Handle<WorldDisplayEnvironmentBase>>,
}

impl Pooled for WorldDisplayEnvironment {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.b_wo.world_display_environment }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.b_wo.world_display_environment }
}
...
pub struct WorldDisplayEnvironmentBase {
    /// DCB field: `alignment` (EnumChoice)
    #[serde(default)]
    pub alignment: String,
    /// DCB field: `environmentColor` (StrongPointer)
    #[serde(default)]
    pub environment_color: Option<Handle<WorldDisplayEnvironmentColor>>,
}

impl Pooled for WorldDisplayEnvironmentBase {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.b_wo.world_display_environment_base }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.b_wo.world_display_environment_base }
}
...
impl Pooled for WorldDisplayEnvironmentColor {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.b_wo.world_display_environment_color }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.b_wo.world_display_environment_color }
}
