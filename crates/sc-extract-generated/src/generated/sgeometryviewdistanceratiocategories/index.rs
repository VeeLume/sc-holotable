...
pub struct SgeometryviewdistanceratiocategoriesIndex {
    pub sgeometry_view_distance_ratio_categories:
        HashMap<CigGuid, Handle<SGeometryViewDistanceRatioCategories>>,
}
...
impl SgeometryviewdistanceratiocategoriesIndex {
    ...
    pub fn len(&self) -> usize {
        ...
        total += self.sgeometry_view_distance_ratio_categories.len();
        total
    }
