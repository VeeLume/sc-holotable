...
pub struct EntitiesScitemUsablesPools {
    ...
    pub closest_orientation_handhold_attach_spot_choice_params:
        Vec<Option<ClosestOrientationHandholdAttachSpotChoiceParams>>,
    pub specific_handhold_attach_spot_choice_params:
        Vec<Option<SpecificHandholdAttachSpotChoiceParams>>,
    ...
    pub ssequencer_player_usable_switch_channel_task_params:
        Vec<Option<SSequencerPlayerUsableSwitchChannelTaskParams>>,
    pub ssequencer_player_usable_scooch_task_params:
        Vec<Option<SSequencerPlayerUsableScoochTaskParams>>,
    pub ssequencer_player_usable_use_channel_task_params:
        Vec<Option<SSequencerPlayerUsableUseChannelTaskParams>>,
    pub ssequencer_player_usable_reserve_slot_task_params:
        Vec<Option<SSequencerPlayerUsableReserveSlotTaskParams>>,
    ...
    pub sentity_component_persistent_entity_entitlement_spawner_params:
        Vec<Option<SEntityComponentPersistentEntityEntitlementSpawnerParams>>,
    pub ssequencer_immediate_despawn_despawner_task_params:
        Vec<Option<SSequencerImmediateDespawnDespawnerTaskParams>>,
    pub entity_effect_system_enable_sequencer_task:
        Vec<Option<EntityEffectSystem_EnableSequencerTask>>,
    pub entity_effect_system_disable_sequencer_task:
        Vec<Option<EntityEffectSystem_DisableSequencerTask>>,
    pub hospital_checkin_screen_component_params: Vec<Option<HospitalCheckinScreenComponentParams>>,
    pub interaction_condition_empty_usable_item_port:
        Vec<Option<InteractionConditionEmptyUsableItemPort>>,
    pub interaction_condition_usable_alignment_slot_empty:
        Vec<Option<InteractionConditionUsableAlignmentSlotEmpty>>,
    pub interaction_condition_available_space_in_linked_usable_item:
        Vec<Option<InteractionConditionAvailableSpaceInLinkedUsableItem>>,
    pub interaction_condition_linked_usable_has_tag:
        Vec<Option<InteractionConditionLinkedUsableHasTag>>,
    ...
    pub usable_channel_input_action_control_interactive:
        Vec<Option<UsableChannelInputAction_ControlInteractive>>,
    pub interactive_variable_back_to_default_int_params:
        Vec<Option<InteractiveVariable_BackToDefaultIntParams>>,
    pub interactive_variable_back_to_default_float_params:
        Vec<Option<InteractiveVariable_BackToDefaultFloatParams>>,
    ...
    pub ssequencer_usable_fill_consumable_task_params:
        Vec<Option<SSequencerUsableFillConsumableTaskParams>>,
