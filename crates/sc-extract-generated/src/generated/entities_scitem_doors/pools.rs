...
pub struct EntitiesScitemDoorsPools {
    ...
    pub sentity_traversing_node_type_zone_host_entity:
        Vec<Option<SEntityTraversingNodeTypeZoneHostEntity>>,
    ...
    pub interaction_condition_eligible_for_prison_release:
        Vec<Option<InteractionConditionEligibleForPrisonRelease>>,
    pub interaction_condition_access_reserved_room:
        Vec<Option<InteractionConditionAccessReservedRoom>>,
