...
impl Pooled for StarMapObjectTypes {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.starmap.star_map_object_types
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.starmap.star_map_object_types
    }
}
...
impl Pooled for StarMapMissionObject {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.starmap.star_map_mission_object
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.starmap.star_map_mission_object
    }
}
...
impl<'a> Extract<'a> for StarMapMissionObject {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            facing_mode: WorldDisplayObjectFacingMode::from_dcb_str(
                inst.get_str("facingMode").unwrap_or(""),
            ),
...
impl Pooled for StarMapPartyMemberObject {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.starmap.star_map_party_member_object
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.starmap.star_map_party_member_object
    }
}
