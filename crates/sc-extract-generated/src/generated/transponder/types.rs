...
impl Pooled for STransponderObjectMetadataParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.transponder.stransponder_object_metadata_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.transponder.stransponder_object_metadata_params }
}
...
impl Pooled for STransponderEntryTrackerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.transponder.stransponder_entry_tracker_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.transponder.stransponder_entry_tracker_params }
}
