...
impl Pooled for SGlobalHitBehaviorParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.sglobalhitbehaviorparams.sglobal_hit_behavior_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.sglobalhitbehaviorparams.sglobal_hit_behavior_params
    }
}
...
impl<'a> Extract<'a> for SGlobalHitBehaviorParams {
    ...
    fn extract(inst: &Instance<'a>, _b: &mut Builder<'a>) -> Self {
        Self {
            damage_per_tick_upper_limit: inst
                .get_f32("damagePerTickUpperLimit")
                .unwrap_or_default(),
