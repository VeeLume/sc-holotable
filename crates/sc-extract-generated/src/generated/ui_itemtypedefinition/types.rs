...
impl Pooled for ItemTypeCategory {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_itemtypedefinition.item_type_category
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_itemtypedefinition.item_type_category
    }
}
...
impl Pooled for ItemTypeCategoryException {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_itemtypedefinition.item_type_category_exception
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_itemtypedefinition.item_type_category_exception
    }
}
        ...
        Self {
            ...
            category: match inst.get("category") {
                Some(Value::StrongPointer(Some(r))) | Some(Value::WeakPointer(Some(r))) => {
                    Some(b.alloc_nested::<ItemTypeCategory>(
...
impl Pooled for ItemTypeCategoryMap {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_itemtypedefinition.item_type_category_map
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_itemtypedefinition.item_type_category_map
    }
}
...
impl<'a> Extract<'a> for ItemTypeCategoryMap {
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            exceptions: inst
                .get_array("exceptions")
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        Value::Class { struct_index, data } => {
                            Some(b.alloc_nested::<ItemTypeCategoryException>(
                                Instance::from_inline_data(b.db, struct_index, data),
                                false,
                            ))
                        }
                        Value::ClassRef(r) => Some(b.alloc_nested::<ItemTypeCategoryException>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
...
impl Pooled for ItemTypeInfo {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_itemtypedefinition.item_type_info
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_itemtypedefinition.item_type_info
    }
}
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            type_name: inst
                ...
                .map(LocaleKey::from)
                .unwrap_or_default(),
            show_in_player_asset_manager: inst
                .get_bool("showInPlayerAssetManager")
                .unwrap_or_default(),
            category_map: match inst.get("categoryMap") {
                Some(Value::Class { struct_index, data }) => {
                    Some(b.alloc_nested::<ItemTypeCategoryMap>(
                        Instance::from_inline_data(b.db, struct_index, data),
                        false,
                    ))
                }
...
impl Pooled for ItemTypeDefinition {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.ui_itemtypedefinition.item_type_definition
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.ui_itemtypedefinition.item_type_definition
    }
}
    ...
    fn extract(inst: &Instance<'a>, b: &mut Builder<'a>) -> Self {
        Self {
            ...
            categories: inst
                ...
                .map(|arr| {
                    arr.filter_map(|v| match v {
                        ...
                        Value::ClassRef(r) => Some(b.alloc_nested::<ItemTypeCategory>(
                            b.db.instance(r.struct_index, r.instance_index),
                            true,
                        )),
                        _ => None,
            ...
            all_categories_label: inst
                ...
                .map(LocaleKey::from)
                .unwrap_or_default(),
            all_types_label: inst
                .get_str("allTypesLabel")
                .map(LocaleKey::from)
                .unwrap_or_default(),
        }
    }
