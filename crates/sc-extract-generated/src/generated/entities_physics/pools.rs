...
pub struct EntitiesPhysicsPools {
    ...
    pub sentity_component_constraint_partner_component_params:
        Vec<Option<SEntityComponentConstraintPartnerComponentParams>>,
    pub slayer_entities_group_component_params: Vec<Option<SLayerEntitiesGroupComponentParams>>,
    pub sentity_articulated_physics_controller_params:
        Vec<Option<SEntityArticulatedPhysicsControllerParams>>,
}
