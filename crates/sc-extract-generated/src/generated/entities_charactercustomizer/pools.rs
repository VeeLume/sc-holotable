...
pub struct EntitiesCharactercustomizerPools {
    pub entity_component_character_customizer_params:
        Vec<Option<EntityComponentCharacterCustomizerParams>>,
    pub scharacter_customizer_loadout_item_replacement_mapping:
        Vec<Option<SCharacterCustomizerLoadoutItemReplacementMapping>>,
    pub scharacter_customizer_head_library_params:
        Vec<Option<SCharacterCustomizerHeadLibraryParams>>,
    ...
    pub scharacter_customizer_default_shader_param:
        Vec<Option<SCharacterCustomizerDefaultShaderParam>>,
    pub scharacter_customizer_clamped_value_params:
        Vec<Option<SCharacterCustomizerClampedValueParams>>,
    ...
    pub scharacter_customizer_extra_texture_params:
        Vec<Option<SCharacterCustomizerExtraTextureParams>>,
    pub scharacter_customizer_multi_texture_params:
        Vec<Option<SCharacterCustomizerMultiTextureParams>>,
    pub scharacter_customizer_base_material_set: Vec<Option<SCharacterCustomizerBaseMaterialSet>>,
    pub scharacter_customizer_skin_base_material_list:
        Vec<Option<SCharacterCustomizerSkinBaseMaterialList>>,
    pub scharacter_customizer_material_edit_params:
        Vec<Option<SCharacterCustomizerMaterialEditParams>>,
    ...
    pub scharacter_customizer_randomization_override_params:
        Vec<Option<SCharacterCustomizerRandomizationOverrideParams>>,
    ...
    pub scharacter_customizer_clipping_volume_params:
        Vec<Option<SCharacterCustomizerClippingVolumeParams>>,
    pub scharacter_customizer_voice_params: Vec<Option<SCharacterCustomizerVoiceParams>>,
    pub scharacter_customizer_complexion_randomization_params:
        Vec<Option<SCharacterCustomizerComplexionRandomizationParams>>,
    pub scharacter_customizer_item_randomization_params:
        Vec<Option<SCharacterCustomizerItemRandomizationParams>>,
    pub scharacter_customizer_hair_randomization_params:
        Vec<Option<SCharacterCustomizerHairRandomizationParams>>,
    pub scharacter_customizer_makeup_slot_randomization_params:
        Vec<Option<SCharacterCustomizerMakeupSlotRandomizationParams>>,
    pub scharacter_customizer_tattoo_randomization_params:
        Vec<Option<SCharacterCustomizerTattooRandomizationParams>>,
    pub scharacter_customizer_random_color_def: Vec<Option<SCharacterCustomizerRandomColorDef>>,
    pub scharacter_customizer_eye_randomization_params:
        Vec<Option<SCharacterCustomizerEyeRandomizationParams>>,
    pub scharacter_customizer_hair_length_override:
        Vec<Option<SCharacterCustomizerHairLengthOverride>>,
    ...
    pub scharacter_customizer_feature_texture_select:
        Vec<Option<SCharacterCustomizerFeatureTextureSelect>>,
    ...
    pub scharacter_customizer_feature_shader_edit:
        Vec<Option<SCharacterCustomizerFeatureShaderEdit>>,
    pub scharacter_customizer_feature_body_type_select:
        Vec<Option<SCharacterCustomizerFeatureBodyTypeSelect>>,
