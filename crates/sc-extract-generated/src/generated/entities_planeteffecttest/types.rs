...
//! Types for feature `entities-planeteffecttest`.
...
impl Pooled for PlanetEffectTestParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> {
        &pools.entities_planeteffecttest.planet_effect_test_params
    }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> {
        &mut pools.entities_planeteffecttest.planet_effect_test_params
    }
}
