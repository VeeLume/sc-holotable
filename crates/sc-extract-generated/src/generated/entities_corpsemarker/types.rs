...
impl Pooled for SEntityComponentCorpseMarkerParams {
    fn pool(pools: &DataPools) -> &Vec<Option<Self>> { &pools.entities_corpsemarker.sentity_component_corpse_marker_params }
    fn pool_mut(pools: &mut DataPools) -> &mut Vec<Option<Self>> { &mut pools.entities_corpsemarker.sentity_component_corpse_marker_params }
}
