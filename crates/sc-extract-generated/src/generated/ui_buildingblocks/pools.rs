...
pub struct UiBuildingblocksPools {
    ...
    pub building_blocks_bindings_color_from_number_rgba:
        Vec<Option<BuildingBlocks_BindingsColorFromNumberRGBA>>,
    pub building_blocks_field_modifier_enumerated_type_max_height_behavior:
        Vec<Option<BuildingBlocks_FieldModifierEnumeratedTypeMaxHeightBehavior>>,
    pub building_blocks_field_modifier_enumerated_type_stroke_alignment:
        Vec<Option<BuildingBlocks_FieldModifierEnumeratedTypeStrokeAlignment>>,
    pub building_blocks_timing_function_custom_curve:
        Vec<Option<BuildingBlocks_TimingFunctionCustomCurve>>,
    ...
    pub building_blocks_widget_environment_probe:
        Vec<Option<BuildingBlocks_WidgetEnvironmentProbe>>,
    ...
    pub building_blocks_component_toggle_list_item:
        Vec<Option<BuildingBlocks_ComponentToggleListItem>>,
    pub building_blocks_component_radial_range_slider:
        Vec<Option<BuildingBlocks_ComponentRadialRangeSlider>>,
    ...
    pub building_blocks_language_specific_font_replacement:
        Vec<Option<BuildingBlocks_LanguageSpecificFontReplacement>>,
    pub building_blocks_trigger_navigation: Vec<Option<BuildingBlocks_TriggerNavigation>>,
    pub building_blocks_trigger_subsumption_broadcast:
        Vec<Option<BuildingBlocks_TriggerSubsumptionBroadcast>>,
