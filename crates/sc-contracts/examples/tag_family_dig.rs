...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let probes = [
        "HumanPilot10", "HumanPilot30", "HumanPilot50", "HumanPilot70", "HumanPilot90",
        "VeryEasy", "Easy", "Medium", "Hard", "VeryHard", "Super",
        "Distortion",
        "CombatShip", "LargeCombatShip", "HeavyInterceptor", "MediumInterceptor",
        "Defenders", "Target", "Bounty",
        "Criminal", "Vanduul", "Civilians", "XenoThreat", "Ninetails",
        "Scythe", "Blade", "Avenger_Titan", "135c", "315p", "Cutlass_Black", "Freelancer_MIS", "RAFT",
        "Mantis", "Scorpius", "Scorpius_Antares",
        "Caterpillar", "StarLifter_C2", "Reclaimer", "Starfarer",
        "Full Cargo", "Half Cargo", "Scraps Cargo",
        "LowValue", "MediumValue", "HighValue", "Mixed",
        "PoweredOff", "EngineOff", "PU_Human_Criminal_Light_wTurret",
        "ArriveViaQT", "DefendShip",
        "General",
    ];
